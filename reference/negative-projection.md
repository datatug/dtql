...
Negative projection selects a source wildcard and subtracts explicitly named
columns. It is a projection operation, not a sensitive-data policy or access
control boundary.
